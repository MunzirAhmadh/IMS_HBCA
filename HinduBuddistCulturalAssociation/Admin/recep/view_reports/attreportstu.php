	...
	$(document).ready(function() {
	   ...
	   // view the employee attandance report
		 $("#btn_attandance").click(function(){
			...
			var url ="http://localhost/HinduBuddistCulturalAssosiation/admin/reports/stu_attandance.php?attdate="+attdate;
			 window.open(url,"new");
		 });
		 ...
		 $("#btn_absent").click(function(){
			...
			var url ="http://localhost/HinduBuddistCulturalAssosiation/admin/reports/stu_absenties.php?attdate="+attdate;
			 window.open(url,"new");
		 });
    });
