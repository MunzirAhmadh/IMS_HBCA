...
<script type="text/javascript">
	...
	//View Daily Enrollment Report - Student wise
		$( "#cmbCou1" ).change(function() {
			...
			var url ="http://localhost/HinduBuddistCulturalAssosiation/admin/reports/enrollment-course.php?couID="+coucode;
		...
		$( "#cmbBatch1" ).change(function() {
			...
			var url ="http://localhost/HinduBuddistCulturalAssosiation/admin/reports/enrollment-batch.php?batchID="+batchcode;
	...
	//------------------------------------------------------Weekly----------------------------------------------	
		...
		$( "#cmbCou2" ).change(function() {
			...
			var url ="http://localhost/HinduBuddistCulturalAssosiation/admin/reports/enrollment-course-week.php?couID="+coucode;
  	 ...
  	 //View Weekly Enrollment  - Batch wise
		$( "#cmbBatch2" ).change(function() {
			...
			var url ="http://localhost/HinduBuddistCulturalAssosiation/admin/reports/enrollment-batch-week.php?batchID="+batchcode;
	  ...
	  //View Weekly Enrollment  - Batch wise
		...
		$( "#cmbCou3" ).change(function() {
			...
			var url ="http://localhost/HinduBuddistCulturalAssosiation/admin/reports/enrollment-course-month.php?couID="+coucode;
		...
		$( "#cmbBatch3" ).change(function() {
			...
			var url ="http://localhost/HinduBuddistCulturalAssosiation/admin/reports/enrollment-batch-month.php?batchID="+batchcode;
	  ...
	  //View Monthly Enrollment  - Batch wise
		...
		$( "#cmbCou4" ).change(function() {
			...
			var url ="http://localhost/HinduBuddistCulturalAssosiation/admin/reports/enrollment-course-year.php?couID="+coucode;
		...
		$( "#cmbBatch4" ).change(function() {
			...
			var url ="http://localhost/HinduBuddistCulturalAssosiation/admin/reports/enrollment-batch-year.php?batchID="+batchcode;
