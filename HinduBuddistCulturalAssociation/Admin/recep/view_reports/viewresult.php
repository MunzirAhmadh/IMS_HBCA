...
<script type="text/javascript">
  ...
  $( "#cmbBatch" ).change(function() {
    ...
    var url ="http://localhost/CollegeManagementSystem/admin/reports/batchresult.php?batchID="+batchcode;
  ...
  $( "#cmbStu" ).change(function() {
    ...
    var url ="http://localhost/CollegeManagementSystem/admin/reports/studentresult.php?enrollID="+stucode;
