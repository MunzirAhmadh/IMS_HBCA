					...
					if($nor > 0)
					{
						...
						?>
							<tr align="center">
								...
								<td align="center">
                               	<?php 
									echo "<button type='button' value=".$setdata['enrollID']." id=".$setdata['enrollID']." class='btn btn-success btn_edit' style='padding:2px' ><span class='glyphicon glyphicon-edit'></span>&nbsp;Edit</button>";
									?>
                                </td>								<td align="center">
									<?php 
