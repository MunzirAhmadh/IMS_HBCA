...
INNER JOIN employee ON employee.empcode = batch.lecId
...
<div class="page">
    ...
    <div class="row">
		<div class="row">
        	 <h4 align="center">
                 Result Sheet - Batch ( <?php echo $enrinfo["batchID"]?> )
              </h4>
        </div>
        </br></br>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <p>: <?php echo $enrinfo["empfname"]." ".$enrinfo["emplname"]?></p>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <table class="table table-default table-bordered "  id="table-data">
                ...
                <tr>
                    ...
                    <th align="center" rowspan="2">Student Id</th>
                ...
                $sql = "SELECT
					...
					WHERE results.batchID ='".$_GET['batchID']."'
                    GROUP BY enrollID";
                ...
                if($nor > 0)
                {
                    ...
                    while ( $setdata = mysqli_fetch_assoc( $result ) )
                    {
                        ...
                        <tr>
                            ...
                            <td align="right"><?php echo $setdata['Written'] ?></td>
                            <td align="right"><?php echo $setdata['Oral'] ?></td>
