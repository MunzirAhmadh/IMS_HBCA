...
$sql_enrinfo = "SELECT * FROM course
WHERE couID ='".$_GET['couID']."'";
...
FROM
enrollment
WHERE couID ='".$_GET['couID']."' AND enrollment.regdate = CURDATE()" ;
...
FROM
enrollment
WHERE couID ='".$_GET['couID']."' AND WEEK(enrollment.regdate) = WEEK(NOW()) AND YEAR(enrollment.regdate) = YEAR(NOW())";
        ...
        <div class="col-sm-12">
            ...
            <table class="table table-default table-bordered "  id="table-data">
                ...
                $sql = "SELECT
				    ...
				    WHERE enrollment.couID ='".$_GET['couID']."' AND enrollment.regdate ='".$today_date."'";
