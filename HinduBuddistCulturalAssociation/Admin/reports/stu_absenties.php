...
/*
$sql_att = "SELECT 
attendancestu.attstuID,
attendancestu.empID,
attendancestu.attstudate,
attendancestu.attstustatus,
employee.empcode,
employee.empfname,
employee.emplname
FROM 
...
<div class="page">
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <p>: <?php echo $attdate["attstudate"]?></p>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <table class="table table-default table-bordered "  id="table-data">
                ...
                $sql =  "SELECT 
							...
							FROM 
							enrollment
							INNER JOIN attendancestu ON attendancestu.enrollID = enrollment.enrollID 
							INNER JOIN student ON student.stucode = enrollment.stuID 
							
							WHERE attstudate ='".$_GET['attdate']."' AND attstustatus=2";
